...
class Aggregator:
    ...
    def aggregate(self) -> pd.DataFrame:
        ...
        general_features = (
            ...
            .agg(
                ...
                first_appearance=("generation", "min"),
        ...
        features_by_rank.columns = [
            f"{feature}_{rank}"
            for feature, rank in features_by_rank.columns
        ]
    ...
    def _explode_source(self) -> pd.DataFrame:
        ...
        df_transformed["monster_hp"] = df_transformed.apply(
            lambda x: x["target_hp"][x["monster"]],
            axis=1
        )
